        ...
        <div class="form-group">
          ...
          <div class="form-check">
            <label class="form-check-label">
              <input type="radio" class="form-check-input" value="skincare" name="jenis_menu" checked>Skincare
            </label>
          </div>
          <div class="form-check">
            <label class="form-check-label">
              <input type="radio" class="form-check-input" value="kosmetik" name="jenis_menu">Kosmetik
            </label>
          </div>
         </div>
        <div class="form-group">
